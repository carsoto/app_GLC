 ...
 <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url ('http://galapagosluxurycharters.com/2') }}">GLC | Galapagos Luxury Charters</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li {{ (Request::is('*registrar_apa') ? 'class="active"' : '') }}>
                            <a href="{{ url ('registrar_apa') }}"><i class="fa fa-dashboard fa-fw"></i> Registrar APA</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
